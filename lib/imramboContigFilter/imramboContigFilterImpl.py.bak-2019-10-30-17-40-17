...
This sample module contains one small method that filters contigs.
    ...
    def run_imramboContigFilter(self, ctx, params):
        """
        ...
        #BEGIN run_imramboContigFilter

        # Print statements to stdout/stderr are captured and available as the App log
        logging.info('Starting run_imramboContigFilter function. Params=' + pformat(params))
        ...
        #END run_imramboContigFilter

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_imramboContigFilter return value ' +
                             'output is not type dict as required.')
        # return the results
        return [output]

    def run_imramboContigFilter_max(self, ctx, params):
        """
        ...
        # ctx is the context object
        # return variables are: output
        #BEGIN run_imramboContigFilter_max
        #END run_imramboContigFilter_max

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_imramboContigFilter_max return value ' +
                             'output is not type dict as required.')
        # return the results
        return [output]

    def run_imramboContigFilter_min(self, ctx, params):
        """
        New app which filters contigs in an assembly using both a minimum and a maximum contig length
        :param params: instance of mapping from String to unspecified object
        :returns: instance of type "ReportResults" -> structure: parameter
        ...
        # ctx is the context object
        # return variables are: output
        #BEGIN run_imramboContigFilter_min
        #END run_imramboContigFilter_min

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_imramboContigFilter_min return value ' +
                             'output is not type dict as required.')
        # return the results
        return [output]
    def status(self, ctx):
